...
export default function Testimonials({
  ...
  console.log(
    data.testimonial.map((index) => {
      return index.testimonial.length;
    })
  );
  // console.log(data.testimonial[0].testimonial.length);
  ...
  return (
    <div
          ...
          <Dialog>
            ...
            <DialogContent className="sm:max-w-[625px] max-h-[90vh] overflow-y-auto">
              ...
              <div className="space-y-4 mt-4">
                ...
                <p className="text-gray-700 leading-relaxed whitespace-pre-line break-words hyphens-auto text-justify">
                  {testimonial}
                </p>
      ...
      <div className="flex items-center mt-6 pt-4 border-t border-gray-200 px-5">
        <div className="relative w-16 h-16 rounded-full overflow-hidden mr-4 border-2 border-teal-100 transition-transform duration-300 group-hover:scale-110">
          <Image
