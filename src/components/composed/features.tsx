...
export default function Features() {
  return (
    <Section style={{
      background: "linear-gradient(230deg, rgb(153, 221, 214) -13.07%, rgb(255, 255, 255) 55%)"
      ...
      <MaxWidthWrapper className="flex flex-col gap-14 md:flex-row mt-20">
        <div className="flex flex-col gap-8 md:w-1/2 z-30 self-center">
          ...
          {/* Heading + Para */}
          <div className="flex flex-col gap-4 max-w-3xl md:h-auto md:justify-between">
          ...
          <Marquee vertical className="p-0 lg:w-5/6 lg:ml-auto">
            {
              features.map((feature, idx) => (
                ...
                // p-6 px-16
                <div key={feature} className="p-4 sm:p-6 sm:px-16 md:p-6 md:text-lg border-2 rounded-xl flex gap-8 justify-between items-center shadow-[inset_0px_20px_207px_10px_rgba(252,_252,_252,_0.6)]">
                  <div>
                    {feature}
                  </div>
