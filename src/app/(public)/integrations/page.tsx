...
//   const endpoint = `/api/integration?populate[thirdPartyAPIs][populate][thirdPartyAPICards][populate][companyLogo][populate][clientLogo][fields]=url&populate[verificationSuite][populate][suiteCards][populate]=features&populate[paymentCollectionChannels][populate][cards][populate]=list`;

//   const data = await fetchAPI<IntegrationPageDataTypes>(endpoint);
...
//         {data.thirdPartyAPIs.thirdPartyAPICards.map(({ heading, tagline, companyLogo, id }, index) => {
...
//           {data.paymentCollectionChannels}
//         </h2>
