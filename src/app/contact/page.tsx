...
export default function ContactPage() {
  ...
  return (
    <Section variant="top" className="min-h-screen bg-gradient-to-b from-white to-teal-50 px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-8">
              ...
              <motion.div
                ...
                <div>
                  ...
                  <a
                    href="mailto:finnauxindia@gmail.com"
                    className="hover:text-teal-600 transition-colors">
                    finnauxindia@gmail.com
                  </a>
                </div>
              </motion.div>

              {/* WhatsApp - Now with matching teal styling */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
