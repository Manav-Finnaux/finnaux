...
export default function AboutUs() {
  ...
  return (
    <>
      ...
      <div className="relative my-12 md:my-24 lg:my-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto"> {/* Added horizontal padding and max-width for better control */}
        {/* Experience Card */}
        ...
        <div
          ...
          data-aos-delay="300"
        >
          <h1 className="bg-gradient-to-b from-cyan-400 to-teal-300 px-4 text-8xl lg:text-9xl text-transparent bg-clip-text text-left"> {/* Adjusted font size */}
            18
          </h1>
          <div className="flex flex-row justify-between items-start gap-2">
            ...
            ></button> {/* Converted to interactive button with hover and focus states */}
            <div className="text-left pr-2 text-sm lg:text-base flex-1"> {/* Adjusted font size */}
        ...
        >
          ...
          <div
            ...
            data-aos-delay="500"
          >
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-medium leading-snug"> {/* Adjusted font size */}
          ...
          <div className="flex flex-col lg:flex-row gap-8 xl:gap-24 px-2 md:px-6 pb-6"> {/* Removed px-4 and md:px-8 from original, using responsive px from parent */}
            <div
            ...
            <div className="flex-1 px-2 md:px-6 py-4 md:py-8">
              <div className="space-y-6 md:space-y-10"> {/* Adjusted spacing */}
                <div
                  data-aos="fade-up"
                  data-aos-delay="700"
                >
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    />
                    <h3 className="font-medium text-xl sm:text-2xl">Our Mission</h3> {/* Adjusted font size */}
                  </div>
                  <p className="text-base sm:text-lg pl-12 sm:pl-14"> {/* Adjusted font size and padding */}
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    <Image
                      ...
                      className="size-10 sm:size-11" // Adjusted icon size for mobile
                    />
                    <h3 className="font-medium text-xl sm:text-2xl">Our Vision</h3> {/* Adjusted font size */}
                  </div>
                  <p className="text-base sm:text-lg pl-12 sm:pl-14"> {/* Adjusted font size and padding */}
      ...
      {/* Our Story Section */}
      <section className="w-full bg-[#f8f8f7] py-16 md:py-24 my-0"> {/* Adjusted padding */}
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-8 lg:gap-16 items-center"> {/* Adjusted gap */}
          {/* Left: Text Content */}
          <div
            ...
            data-aos-delay="100"
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-gray-900"> {/* Adjusted font size */}
              Our Story
            </h2>
            <p className="text-base sm:text-lg text-gray-700 mb-8 sm:mb-10"> {/* Adjusted font size and margin */}
            ...
            <div className="relative pl-6 sm:pl-8"> {/* Adjusted padding */}
              ...
              <div className="space-y-6 sm:space-y-8"> {/* Adjusted spacing */}
                {[
                  ...
                  >
                    <div className="flex items-baseline gap-2 sm:gap-3"> {/* Adjusted gap */}
                      <span className="text-gray-400 font-mono text-base sm:text-lg"> {/* Adjusted font size */}
                        {item.num}
                      </span>
                      <span className="font-semibold text-lg sm:text-xl text-gray-900"> {/* Adjusted font size */}
                        {item.title}
                      </span>
                    </div>
                    <p className="text-sm sm:text-base text-gray-600 ml-8 sm:ml-10 mt-1">{item.desc}</p> {/* Adjusted font size and margin */}
                  </div>
                ))}
              </div>
            </div>
