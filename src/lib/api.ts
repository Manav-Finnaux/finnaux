...
export const HOMEPAGE_API = `/home-page?populate[heroSection][populate]=cta&populate[clientLogosMarquee][populate][clientLogo][fields][0]=url&populate[aboutUsSection][populate][image][fields][0]=url&populate[modulesSection][populate][moduleLinks][populate][module][fields][0]=documentId&populate[featuresSection][populate]=feature&populate[whyChooseUsSection][populate]=whyChooseUsCard&populate[testimonialsSection][populate][testimonial][populate][avatar][fields][0]=url&populate[faqsSection][populate]=qna&populate[aboutUsSection][populate][cta]=true`;
...
export const FOOTER_API = `/footer?populate[linkGroup][populate]=footerLink`;